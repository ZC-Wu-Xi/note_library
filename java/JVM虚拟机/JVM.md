...
<img src="./JVMImg/JVM-概述图.png" style="zoom: 80%;" />
...
<img src="./JVMImg/JVM-JRE关系.png" style="zoom: 80%;" />
...
* Java1.8 以前的内存结构图：
  ![](./JVMImg/JVM-Java7内存结构图.png)

* Java1.8 之后的内存结果图：

  ![](./JVMImg/JVM-Java8内存结构图.png)
...
* 每个栈由多个栈帧（Frame）组成，对应着每次方法调用时所占用的内存，每个栈帧中存储着：
  ...
  * 操作数栈或表达式栈和其他一些附加信息
  ...
  <img src="./JVMImg/JVM-虚拟机栈.png" style="zoom:50%;" />
...
<img src="./JVMImg/JVM-本地方法栈.png" style="zoom:67%;" />
...
<img src="./JVMImg/JVM-内存图对比.png" style="zoom: 67%;" />
...
<img src="./JVMImg/JVM-分代收集算法.png" style="zoom: 67%;" />
...
- 在可达性分析算法中，只有能够被根对象集合直接或者间接连接的对象才是存活对象
  ...
  <img src="./JVMImg/JVM-可达性分析算法.png" style="zoom: 50%;" />
...
<img src="./JVMImg/JVM-三色标记法过程.gif" style="zoom: 67%;" />
...
<img src="./JVMImg/JVM-三色标记法多标情况.png" style="zoom: 50%;" />
...
<img src="./JVMImg/JVM-三色标记法漏标情况.png" style="zoom:50%;" />
...
<img src="./JVMImg/JVM-标记清除算法.png" style="zoom: 67%;" />
...
<img src="./JVMImg/JVM-标记整理算法.png" style="zoom:67%;" />
...
![](./JVMImg/JVM-ParallelScavenge收集器.png)
...
<img src="./JVMImg/JUC-G1记忆集.png" style="zoom:67%;" />
...
<img src="./JVMImg/JVM-G1回收过程.png" style="zoom: 50%;" />
...
<img src="./JVMImg/JVM-对象的实际大小.png" style="zoom: 67%;" />
...
<img src="./JVMImg/JVM-类的生命周期-加载.png" style="zoom:80%;" />
...
<img src="./JVMImg/JVM-双亲委派模型.png" style="zoom: 50%;" />
...
<img src="./JVMImg/JVM-热替换.png" style="zoom: 33%;" />
...
<img src="./JVMImg/JVM-沙箱机制.png" style="zoom:67%;" />
...
<img src="./JVMImg/JVM-高级语言执行过程.png" style="zoom:50%;" />
...
<img src="./JVMImg/JVM-字节码指令同步控制.png" style="zoom: 33%;" />
...
* **执行引擎**开始执行字节码
  ...
  * 这里小的数字都是和字节码指令存在一起，超过 short 范围的数字存入了常量池
  ...
  ![](./JVMImg/JVM-字节码执行流程3.png)

  `istore_3`：将操作数栈顶数据弹出，存入局部变量表的 slot 3

  `getstatic #4`：获取静态字段

  ![](./JVMImg/JVM-字节码执行流程4.png)

  `iload_3`：

  ![](./JVMImg/JVM-字节码执行流程5.png)
...
<img src="./JVMImg/JVM-虚方法表.png" style="zoom: 80%;" />
