...
![](./javaNET网络编程Img/IO模型-非阻塞式IO.png)
...
![](./javaNET网络编程Img/IO模型-信号驱动IO.png)
...
![](./javaNET网络编程Img/IO模型-IO复用模型.png)
...
![](./javaNET网络编程Img/IO模型-异步IO模型.png)
...
![](./javaNET网络编程Img/IO-select调用过程.png)
...
<img src="./javaNET网络编程Img/IO-DMA.png" style="zoom: 50%;" />
...
![](./javaNET网络编程Img/IO-BIO工作流程.png)

read 调用图示：read、write 都是系统调用指令

<img src="./javaNET网络编程Img/IO-缓冲区读写.png" style="zoom: 67%;" />
...
![](./javaNET网络编程Img/IO-mmap工作流程.png)
...
![](./javaNET网络编程Img/IO-sendfile工作流程.png)
...
<img src="./javaNET网络编程Img/三次握手.png" alt="三次握手" style="zoom: 50%;" />

<img src="./javaNET网络编程Img/四次挥手.png" alt="四次挥手" style="zoom: 67%;" />
...
* 常用 API：`public Socket accept()`，**阻塞等待**接收一个客户端的 Socket 管道连接请求，连接成功返回一个 Socket 对象
  ...
  <img src="./javaNET网络编程Img/Netty-TCP三次握手.png" style="zoom:67%;" />
...
![](./javaNET网络编程Img/BIO工作机制.png)

![](./javaNET网络编程Img/TCP-工作模型.png)
...
* 位置、限制、容量遵守以下不变式： **0 <= position <= limit <= capacity**
  ...
  <img src="./javaNET网络编程Img/NIO-Buffer操作.png" style="zoom:67%;" />
...
<img src="./javaNET网络编程Img/JVM-直接内存直接缓冲区.png" style="zoom: 50%;" />

<img src="./javaNET网络编程Img/JVM-直接内存非直接缓冲区.png" style="zoom:50%;" />
...
![](./javaNET网络编程Img/NIO-Selector.png)
