...
* 一个数组内存图
  ...
  ![](./JavaSEImg/数组内存分配-一个数组内存图.png)

* 两个数组内存图

  ![](./JavaSEImg/数组内存分配-两个数组内存图.png)

* 多个数组指向相同内存图

  ![](./JavaSEImg/数组内存分配-多个数组指向一个数组内存图.png)
...
* resize()：
  ...
  ![](./JavaSEImg/HashMap-resize扩容.png)
