...
<img src="./assets/LinuxImg/操作系统.png" style="zoom:80%;" />

移动设备操作系统：

![](./assets/LinuxImg/移动设备操作系统.png)
...
![Linux](./assets/LinuxImg/Linux系统.png)
...
![Linux文件系统](./assets/LinuxImg/Linux文件系统.png)
...
首先设置虚拟机中 NAT 模式的选项，打开 VMware，点击编辑下的虚拟网络编辑器，设置 NAT 参数
	![](./assets/LinuxImg/配置NAT.jpg)

**注意**：VMware Network Adapter VMnet8 保证是启用状态

​	![](./assets/LinuxImg/本地主机网络连接.jpg)
...
* 在虚拟机中访问网络，需要增加一块 NAT 网卡
  * 【虚拟机】--【设置】--【添加】
  * <img src="./assets/LinuxImg/两块NAT网卡.jpg" style="zoom:80%;" />
...
<img src="./assets/LinuxImg/文件权限.png" style="zoom: 50%;" />
...
<img src="./assets/LinuxImg/权限数字表.png" style="zoom: 67%;" />
...
<img src="./assets/LinuxImg/文件链接.png" style="zoom: 80%;" />
...
* `ifconfig`：显示激活的网卡信息  ens
  <img src="./assets/LinuxImg/网卡信息.png"  />
